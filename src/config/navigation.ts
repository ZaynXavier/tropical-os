...
export const MASTER_NAVIGATION: NavigationModule[] = [
  ...
  // 5. TROPICAL CRM & MARKETING
  {
    ...
    description: 'WhatsApp Multi-Agent Hub, 360° Tamu, Banquet Pipeline, & Otomatisasi Retensi',
    badge: 'Tamu & WA',
    badgeColor: 'pink',
    allowedRoles: ['OWNER', 'MANAGER', 'SUPERVISOR', 'STAFF'],
    submodules: [
      {
        ...
        path: '/crm',
        subParam: 'whatsapp',
        description: 'Multi-Agent WhatsApp chat live dengan tamu, template quick replies, dan broadcast blast',
        allowedRoles: ['OWNER', 'MANAGER', 'SUPERVISOR', 'STAFF'],
      },
      {
        id: 'customers-360',
        name: 'Direktori 360° Tamu',
        path: '/crm',
        subParam: 'customers',
        description: 'Database profil tamu lengkap, LTV belanja, preferensi meja/makanan, dan riwayat kunjungan',
        allowedRoles: ['OWNER', 'MANAGER', 'SUPERVISOR', 'STAFF'],
      },
      {
        id: 'pipeline',
        name: 'Event & Banquet Pipeline',
        path: '/crm',
        subParam: 'pipeline',
        description: 'Kanban board prospek event wedding, gathering kantor, food tasting, dan pembuatan invoice penawaran',
        allowedRoles: ['OWNER', 'MANAGER', 'SUPERVISOR'],
      },
      {
        id: 'crm-automation',
        name: 'Otomatisasi & Review Booster',
        path: '/crm',
        subParam: 'automation',
        description: 'Konfirmasi booking otomatis, pengingat H-1 anti no-show, voucher ulang tahun, dan booster Google Review',
        allowedRoles: ['OWNER', 'MANAGER', 'SUPERVISOR'],
      },
      {
        id: 'reservations',
        ...
        path: '/crm',
        subParam: 'calendar',
        description: 'Booking meja resto, reservasi VIP room, dan follow-up tamu',
        allowedRoles: ['OWNER', 'MANAGER', 'SUPERVISOR', 'STAFF'],
      },
      {
